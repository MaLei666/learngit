...
#
#     #get请求到微信搜索引擎
#     self.log(u'开始获取，微信公众号名称为：%s'%self.keywords)
#     self.log(u'开始调用搜索引擎')
#     sogou_search_html=self.get_search_result_by_keywords()
...
if __name__ == '__main__':
    ...
    #使用代理ip访问网址
    URL=('https://www.baidu.com/s?ie=utf-8&f=8&rsv_bp=1&tn=monline_4_dg&wd=webdriver%20%E8%AE%BE%E7%BD%AEip&oq=webdriver%2520proxy&rsv_pq=cef2d36500007c57&rsv_t=a23bl1rptZfZYfg3Cw0mlncWSnUOFtpVfLzTRZWdNmxxWM240qBhaIIICBx0zgYdFBCH&rqlang=cn&rsv_enter=0&inputT=4&rsv_sug3=31&rsv_sug1=21&rsv_sug7=100&rsv_sug2=0&rsv_sug4=1902')
    browser = webdriver.ChromeOptions()
    #使用代理ip无法访问
    browser.add_argument('--proxy-server=http://' + proxy_dict)
